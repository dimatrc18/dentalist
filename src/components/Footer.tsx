    ...
    <footer className="footer" role="contentinfo">
      <div className="container">
        <div className="footer__inner">
          ...
          <div className="footer__brand">
            <div className="footer__logo">
              <span className="footer__logo-title">Dentalist</span>
            </div>
            <p className="footer__brand-desc">
              Providing expert, compassionate dental care to families across Schaerbeek.
          ...
          <address style={{ fontStyle: 'normal' }}>
            ...
            <div className="footer__contact-item">
              ...
              <span>Av. Louis Bertrand 102D<br />1030 Schaerbeek</span>
            </div>
            <div className="footer__contact-item">
              <svg viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <a href="tel:028080256">028080256</a>
            </div>
            <div className="footer__contact-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/>
              </svg>
              <a href="mailto:info@dentalist.be">info@dentalist.be</a>
            </div>

            <div className="footer__hours" aria-label="Opening hours">
              {[
                ['Mon, Tue, Thu', '9:30 am – 6:15 pm'],
        ...
        <div className="footer__bottom" style={{ justifyContent: 'center' }}>
          <p>© {currentYear} Dentalist. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
