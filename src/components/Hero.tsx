      ...
      <div className="hero__inner">
        ...
        >
          ...
          <motion.p className="hero__description" variants={itemVariants}>
            Expert general dentistry, implants, whitening, and orthodontics in Schaerbeek. We fix, clean, and care for your teeth with precision and warmth.
          </motion.p>
          ...
          <motion.div className="hero__trust" variants={itemVariants}>
            ...
            <div className="hero__trust-text">
              Trusted by 1,000+ patients in Schaerbeek<br />
              Providing care since 2012
            </div>
          </motion.div>
        </motion.div>
