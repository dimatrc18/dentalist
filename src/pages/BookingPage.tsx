...
const CLINIC_SLOTS: Record<number, string[]> = {
  1: ["09:30", "10:00", "10:30", "11:00", "11:30", "12:00", "12:30", "13:00", "13:30", "14:00", "14:30", "15:00", "15:30", "16:00", "16:30", "17:00", "17:30", "18:00"],
  2: ["09:30", "10:00", "10:30", "11:00", "11:30", "12:00", "12:30", "13:00", "13:30", "14:00", "14:30", "15:00", "15:30", "16:00", "16:30", "17:00", "17:30", "18:00"],
  3: ["09:30", "10:00", "10:30", "11:00", "11:30", "12:00", "12:30", "13:00", "13:30", "14:00", "14:30", "15:00", "15:30", "16:00", "16:30", "17:00"],
  4: ["09:30", "10:00", "10:30", "11:00", "11:30", "12:00", "12:30", "13:00", "13:30", "14:00", "14:30", "15:00", "15:30", "16:00", "16:30", "17:00", "17:30", "18:00"],
  5: ["09:30", "10:00", "10:30", "11:00", "11:30", "12:00", "12:30", "13:00", "13:30", "14:00", "14:30", "15:00", "15:30", "16:00", "16:30", "17:00", "17:30"],
    ...
    <div>
      ...
      <div className="bk-cal__grid">
        {cells.map((day, i) => {
          ...
          const off   = isPast(date) || !CLINIC_SLOTS[dow];
          const sel   =
            selectedDate &&
...
export default function BookingPage() {
  ...
  if (confirmed) {
    return (
      <div className="bk-page">
        <Helmet>
          <title>Booking Confirmed | Dentalist</title>
        </Helmet>
        <div className="bk-confirmed step-enter">
          ...
          <div className="bk-confirmed__card">
            ...
            <div className="bk-confirmed__row">
              <MapPin size={16} />
              Av. Louis Bertrand 102D, 1030 Schaerbeek
            </div>
            <div className="bk-confirmed__row">
              <span>📅</span>
          ...
          <p className="bk-confirmed__note">
            ...
            appointment at <strong>028080256</strong>.
          </p>
  ...
  return (
    <div className="bk-page">
      <Helmet>
        <title>Book an Appointment | Dentalist</title>
                ...
                <form className="bk-form" onSubmit={handleSubmit}>
                  ...
                  <div className="bk-field">
                    ...
                    <select id="bk-insurance" name="insurance">
                      ...
                      <option>Partenamut (INAMI/RIZIV)</option>
                      <option>Solidaris (INAMI/RIZIV)</option>
                      <option>Christelijke Mutualiteit / CM (INAMI/RIZIV)</option>
                      <option>Other INAMI/RIZIV Mutual Fund</option>
                      <option>Private / Corporate Insurance</option>
                      <option>None</option>
                    </select>
                  </div>
        ...
        {step !== 'form' && (
          <div className="bk-info-strip">
            <div className="bk-info-item">
              <MapPin size={15} />
              <span>Av. Louis Bertrand 102D, 1030 Schaerbeek</span>
            </div>
            <div className="bk-info-item">
              <Clock size={15} />
              <span>Mon, Tue, Thu 9:30–18:15 · Wed 9:30–17:30 · Fri 9:30–17:45 · Sat 10:00–12:30</span>
            </div>
            <div className="bk-info-item">
              <Phone size={15} />
              <Link to="tel:028080256" style={{ color: 'var(--clr-primary-light)', fontWeight: 600 }}>
                028080256
              </Link>
            </div>
          </div>
