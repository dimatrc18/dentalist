...
const TRUST_ITEMS = [
  ...
  { value: 'Since 2012', label: 'Serving Schaerbeek' },
];

const WHY_US = [
  {
    title: 'No surprises.',
    body: 'You know the price before you sit down. We contact your mutualiteit ahead of every appointment.',
  },
  {
  ...
  {
    title: 'Modern, comfortable treatment.',
    body: 'Digital scanning and 3D imaging mean greater precision, less chair time, and a noticeably different experience.',
  },
  {
    title: 'For the whole family.',
    body: 'From your child\'s first visit to implants and orthodontics as an adult — one clinic for every stage of life.',
  },
  {
    title: 'Clear communication.',
    body: 'Dutch, French, English. You are always understood, never rushed, and never left guessing.',
  },
];
...
const TESTIMONIALS = [
  {
    ...
    img: smileSophie,
    rating: 5,
    text: 'Top-notch dental practice! Warm welcome and quality care from a professional and attentive team. Appointments are very well organized.',
  },
  {
    name: 'Reyhan Cicek',
    location: 'Schaerbeek',
    img: smileMarc,
    rating: 5,
    text: 'A very professional and attentive dentist. You feel safe and secure. He really takes the time to explain everything thoroughly.',
  },
  {
    name: 'Selma Slma',
    location: 'Schaerbeek',
    img: smileJulie,
    rating: 5,
    text: 'A very professional, attentive, and reassuring dentist. I\'ve been a patient for several years and have always appreciated the quality of his work.',
  },
];
...
export default function About() {
  return (
    <>
      <Helmet>
        <title>About Us | Dentalist</title>
        <meta
          name="description"
          content="Modern dental care in Schaerbeek — transparent pricing, 4 specialist services, RIZIV/INAMI accredited. Book your visit today."
        />
      </Helmet>
        ...
        <section className="abt-human section">
          <div className="container abt-human__grid">
            <div className="abt-human__image" data-reveal data-reveal-dir="left">
              <img src={aboutDoctor} alt="Dr. Davidson, lead dentist" className="abt-human__photo" />
              <div className="abt-human__quote-card">
                <p>"I take the time to explain everything thoroughly so you feel safe and secure."</p>
                <span>— Our Lead Dentist</span>
              </div>
            </div>
